...
use App\Services\ComputePowerService;
use Slowlyo\OwlAdmin\Controllers\AdminController;

/**
 * 算力管理
 *
 * @property ComputePowerService $service
 */
class ComputePowerController extends AdminController
{
	protected string $serviceName = ComputePowerService::class;
	...
	public function list()
	{
		$crud = $this->baseCRUD()
			...
			->columns([
				...
				amis()->TableColumn('power_value', '算力值')->sortable(),
	...
	public function form($isEdit = false)
	{
		return $this->baseForm()->body([
			...
			amis()->NumberControl('amount', '充值金额')
				...
				->min(0.01)
				->required(),
			// amis()->TextareaControl('description', '算力介绍'),
