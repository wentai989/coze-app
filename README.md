...
# cozeFz
cozeFz 是一款基于 Coze 扣子API 封装的小程序与 H5 应用，深度集成智能体对话、工作流及支付变现能力的商业化解决方案。

## 📂 功能特点
- **小程序/H5端**: AI 流式对话、异步工作流、应用广场、用户管理/会员充值/算力充值/卡密兑换/分销拉新  等。
- **管理后台**: 用户/订单管理、商户管理、支付配置、会员设置、算力设置、分销配置、卡密管理、扣子配置、系统设置 等。
...
项目初衷是为了更好地服务 Coze 扣子封装变现客户，提供持续的维护与技术支持。欢迎志同道合的朋友交流探讨。
